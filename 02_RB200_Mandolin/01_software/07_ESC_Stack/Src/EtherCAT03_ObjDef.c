...
//
//*************************************************************************************************
// 0x1000 (Device type) variable to handle the object data
UINT32 u32Devicetype = 0x00020186;
const TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x1000 = {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ};
const UCHAR OBJMEM aName0x1000[] = "Device type";
...
//
//*************************************************************************************************
// 0x1001 (Error Register) variable to handle the object data
...
//
//*************************************************************************************************
// 0x1008 (Device name) variable to handle the object data
...
//
//*************************************************************************************************
// 0x1009 (Hardware version) variable to handle the object data
...
//
//*************************************************************************************************
// 0x100A (Software version) variable to handle the object data
...
// 0x1018 (Identity) entry descriptions
// Subindex 000
...
//
//*************************************************************************************************
// 0x10F1 (Error settings) entry description
// Subindex 000
...
//
//*************************************************************************************************
// 0x1C00 (Sync manager type) variable to handle the object data
