...
void InitXintf(void)
{
    ...
    // All Zones---------------------------------
    EALLOW;
    XintfRegs.XINTCNF2.bit.XTIMCLK = 0; // XTIMCLK = 1/1 SYSCLKOUT
    XintfRegs.XINTCNF2.bit.WRBUFF = 0;  // No write buffering
    XintfRegs.XINTCNF2.bit.CLKOFF = 1;  // XCLKOUT不输出信号，spru949, sec 2.2
...
#endif
    XintfRegs.XTIMING0.bit.X2TIMING = 0;    // no double

    XintfRegs.XTIMING0.bit.USEREADY = 0;    // 不使用XREADY
...
//     GpioCtrlRegs.GPAMUX2.bit.GPIO30 = 3;  // XA18
     //GpioCtrlRegs.GPAMUX2.bit.GPIO29 = 3;  // XA19.   SCITX
...
//     GpioCtrlRegs.GPAMUX2.bit.GPIO28 = 3;  // XZCS6. 作为SCIRX
     EDIS;
}
