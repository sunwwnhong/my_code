...
#define CPU_FRQ_150MHZ   1      // 150 MHz CPU Freq
#define CPU_FRQ_100MHZ   0      // 100 MHz CPU Freq
#define CPU_FRQ_60MHZ    0      //  60 MHz CPU Freq

//==============================================================================
//==============================================================================
#define HW_CRYSTAL      30      // 30MHz¾§Õñ
//#define HW_CRYSTAL      20      // 20MHz¾§Õñ
//==============================================================================
...
#if (HW_CRYSTAL == 30)      // 30MHz¾§Õñ
#define DSP28_PLLCR     4
#elif 1                     // 20MHz¾§Õñ
#define DSP28_PLLCR     6
#endif
#define CPU_RATE        16.66666666667L

#define DSP_CLOCK       60

#elif CPU_FRQ_100MHZ        // 100MHz

#define DSP28_PLLCR     10  // 20MHz¾§Õñ
#define CPU_RATE        10.0L

#define DSP_CLOCK       100

#elif CPU_FRQ_150MHZ        // 150MHz

#define DSP28_PLLCR     10  // 30MHz¾§Õñ
#define CPU_RATE        6.66666666667L

#define DSP_CLOCK       150

#endif

#define CPU_FRQ         (DSP_CLOCK*1000000UL)
