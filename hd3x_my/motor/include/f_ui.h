...
#define RCK (GpioDataRegs.GPBDAT.bit.GPIO57) // 与74HC594/165的配合
#define KEYSEL (GpioDataRegs.GPBDAT.bit.GPIO57) // 与74HC594/165的配合//(GpioDataRegs.AIODAT.bit.AIO4)
#else
#define RCK (GpioDataRegs.GPBDAT.bit.GPIO57) // 与74HC594/165的配合
#endif
...
extern void InitSetSpiForFunc(void);
