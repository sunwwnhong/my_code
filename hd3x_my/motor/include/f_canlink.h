...
#define		CAN_REMOTE_EN   		1						// CAN远程帧使能
...
#define		CAN_LINK_BAUD_SEL		    ((funcCode.code.commBaudRate >> 12) & 0x07)

#define     P2P_COMM_HOST           1         // 点对点通讯主机
#define     P2P_COMM_SLAVE          2         // 点对点通讯从机
#define     P2P_COMM_SLAVE1         3         // 点对点通讯从机

#define     P2P_SLAVE_NUMBER_MAX    3
...
struct CAN_MASTER_CMD_BIT
{
    ...
    Uint16 stopMode:1;          // BIT3: rsvd2 // LS_20221215
    Uint16 runFlag:1;           // BIT4 主机运行标记
    Uint16 mainF009:1;          // BIT5 主机的F0-09

    Uint16 reset:1;             // BIT6 Reset slave // LS_20240219
    Uint16 rsvd:1;              // BIT7 保留
...
// can 状态字 // LS_20240229
#define SLAVE_STATUS_MASK       0x007F
#define SLAVE_STATUS_IDX        0x0001
#define SLAVE_COMM_ERR_IDX      0x0100
struct CAN_SLAVE_STATUS_BIT
{
    Uint16 Slave1NotRun: 1;     // BIT0: 从机1 有故障
    Uint16 Slave2NotRun: 1;     // BIT1: 从机2 有故障
    Uint16 Slave3NotRun: 1;     // BIT2: 从机3 有故障
    Uint16 Slave4NotRun: 1;     // BIT3: 从机4 有故障
    Uint16 Slave5NotRun: 1;     // BIT4: 从机5 有故障
    Uint16 Slave6NotRun: 1;     // BIT5: 从机6 有故障
    Uint16 Slave7NotRun: 1;     // BIT6: 从机7 有故障
    Uint16 err: 1;              // BIT7: 0: 报警; 1: 故障

    Uint16 Slave1CommErr: 1;    // BIT8:  从机1 通讯故障
    Uint16 Slave2CommErr: 1;    // BIT9:  从机2 通讯故障
    Uint16 Slave3CommErr: 1;    // BIT10: 从机3 通讯故障
    Uint16 Slave4CommErr: 1;    // BIT11: 从机4 通讯故障
    Uint16 Slave5CommErr: 1;    // BIT12: 从机5 通讯故障
    Uint16 Slave6CommErr: 1;    // BIT13: 从机6 通讯故障
    Uint16 Slave7CommErr: 1;    // BIT14: 从机7 通讯故障
    Uint16 rsvd: 1;             // Bit15: 保留
};
...
extern union CAN_SLAVE_STATUS canSlaveStatus;
extern Uint16 canSlaveStatusBak; // LS_20240229
extern Uint16 MsDiagTimer; // LS_20240229
extern Uint16 SynFrq;
