...
#define FUNCCODE_paraInitMode_CLEAR_POWERADD        110 // 清除累计耗电量
#define FUNCCODE_paraInitMode_CLEAR_TIMEADD         470 // 清除累计运行时间
...
extern Uint16 GetEepromIndexFromFcIndex(Uint16 index);
extern Uint16 GetFcIndexFromEepromIndex(Uint16 a);
