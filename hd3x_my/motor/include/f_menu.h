...
#if 0
#define COMPANY_PASSWORD        1531           // 厂家密码，功能调试时设置密码为1，方便调试
#else
#define COMPANY_PASSWORD        1531          // 厂家密码
#endif
...
extern Uint16 GetFuncCodeInitOriginal(Uint16 index);


// 某些功能码是其他功能码上下限的处理
 void LimitOtherCodeDeal(Uint16 index);
